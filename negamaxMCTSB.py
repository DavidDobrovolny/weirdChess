...
class NegamaxMCTSPlayerB:
    """
    Negamax - Monte Carlo Tree Search abomination with limited breadth
    """

    def __init__(self, num, d1=3, d2=5, t=10, b=10):
        self.number = num
        self.nDepth = d1
        self.mDepth = d2
        self.thinkTime = t
    ...
    def __str__(self):
        return "NegamaxMCTS nDepth {0.nDepth}, mDepth {0.mDepth}, thinkTime {0.thinkTime}, breadth {0.breadth}".format(self)
    ...
    def choose(self, gameInst):
        ...
        possible = {move_to_tuple(x.move): [0, 0] for x in self.moveTree.childMoves[:self.breadth] if -x.value > -500}  # avoid guaranteed losses
